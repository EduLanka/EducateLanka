...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <body id="body-pd">
      <header class="header" id="header">
         ...
         <div class="header_img"> <img src="https://static.vecteezy.com/system/resources/previews/007/296/443/original/user-icon-person-icon-client-symbol-profile-icon-vector.jpg" alt="" title="{{Auth::user()->name}}"> </div>
      </header>
         ...
         <nav class="nav">
            <div>
               ...
               <div class="nav_list">
                  ...
                  <a href="#" title="Settings" class="nav_link"> <i class='bx bx-cog nav_icon'></i> <span class="nav_name">Settings</span> </a> 
