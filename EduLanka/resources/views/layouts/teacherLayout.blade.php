      ...
      <div class="l-navbar" id="nav-bar">
         <nav class="nav">
            <div>
               ...
               <div class="nav_list">
                  <a href="{{route('teacher.index')}}" class="nav_link {{ request()->is('teacher') ? 'active' : '' }}"> <i class='bx bx-home nav_icon'></i> <span class="nav_name">Dashboard</span></a>

                  <a href="{{route('teacher.courses')}}" class="nav_link {{ request()->is('teacher/courses') ? 'active' : '' }}"> <i class='bx bx-book nav_icon'></i> <span class="nav_name">Courses</span> </a> 
